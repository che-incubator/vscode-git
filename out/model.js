    ...
    class Model {
        ...
        async openRepository(path) {
            ...
            try {
                ...
                const repository = new repository_1.Repository(this.git.open(repositoryRoot, dotGit), this.globalState, this.outputChannel);
