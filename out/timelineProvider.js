...
let GitTimelineProvider = /** @class */ (() => {
    class GitTimelineProvider {
        constructor(_model) {
            ...
            this.disposable = vscode_1.Disposable.from(_model.onDidOpenRepository(this.onRepositoriesChanged, this), vscode_1.workspace.registerTimelineProvider(['file', 'git', 'vscode-remote', 'gitlens-git'], this));
        }
        get onDidChange() {
